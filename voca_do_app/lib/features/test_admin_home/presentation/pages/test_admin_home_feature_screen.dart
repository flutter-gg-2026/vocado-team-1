...
import 'package:voca_do_app/features/sub/task_generator/presentation/pages/task_generator_feature_widget.dart';
...
class TestAdminHomeFeatureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [SignOutFeatureWidget(), TaskGeneratorFeatureWidget()],
      ),
    );
  }
}
