...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskCreatorModel&&(identical(other.transcript, transcript) || other.transcript == transcript));
}
...
@override
String toString() {
  return 'TaskCreatorModel(transcript: $transcript)';
}
...
/// Create a copy of TaskCreatorModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? transcript = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String transcript)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskCreatorModel() when $default != null:
return $default(_that.transcript);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String transcript)  $default,) {final _that = this;
switch (_that) {
case _TaskCreatorModel():
return $default(_that.transcript);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String transcript)?  $default,) {final _that = this;
switch (_that) {
case _TaskCreatorModel() when $default != null:
return $default(_that.transcript);case _:
  return null;
...
class _TaskCreatorModel implements TaskCreatorModel {
  const _TaskCreatorModel({required this.transcript});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaskCreatorModel&&(identical(other.transcript, transcript) || other.transcript == transcript));
}
...
/// Create a copy of TaskCreatorModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? transcript = null,}) {
