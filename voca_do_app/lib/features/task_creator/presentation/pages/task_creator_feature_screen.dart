  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<TaskCreatorCubit, TaskCreatorState>(
      listener: (context, state) {
        if (state is TaskCreatorResultSuccessState) {
          showDialog(
            context: context,
            builder: (dialogContext) => AlertDialog(
              title: Text("Confirm Task Details"),
              content: Column(
                children: [
                  Text("Task description:"),
                  Text(state.task.task),
                  Text("Task Assignee:"),
                  Text(state.task.assignee ?? 'To be determined'),
                  Text("Task Due Date:"),
                  Text(state.task.dueDate ?? 'To be determined'),
                ],
              ),
              actions: [
                TextButton(
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: [
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: isRecording
                                ...
                                : const [
                                    Color.fromARGB(255, 17, 210, 7),
                                    Color.fromARGB(255, 181, 245, 78),
                                  ],
                          ),
                          boxShadow: [
                            BoxShadow(
                    ...
                    if (isLoading) ...[const Gap(28), LoadingWidget()],
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: () {
                                ...
                                cubit.parseTaskWithAi(transcription: text!);
                              },
